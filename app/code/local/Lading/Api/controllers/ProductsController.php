    ...
    public function getProductDetailAction() {
        ...
        switch($product_type){
            ...
            case Mage_Catalog_Model_Product_Type::TYPE_SIMPLE: {
                ...
                $product_detail['qty'] = (int)Mage::getModel('cataloginventory/stock_item')->loadByProduct($product)->getQty();
        ...
        $product_detail['is_available'] = $stock->getIsInStock();
...
//        $product_detail['description'] = $product->getDescription();
        ...
        echo json_encode(array('code'=>0, 'message'=>null, 'data'=>$product_detail));
    }
