...
class Lading_Api_AddressController extends Mage_Core_Controller_Front_Action
{
    ...
    public function getAddressListAction(){
        ...
        //print_r($customer);exit;
         array_walk_recursive($addressList, function (&$item, $key) {
                        $item = null === $item ? '' : $item;
                    });
    ...
    public function getAddressAction(){
        ...
        array_walk_recursive($return_address, function (&$item, $key) {
                        $item = null === $item ? '' : $item;
                    });
        echo json_encode(
            array(
    ...
    public function deleteAction(){
        ...
        $result = array (
            'code' => 0,
            'message' => "Your address has been removed from list.",
            'data' => true
        );
            ...
            try {
             ...
             //  print_r($address);exit;
               // $address->setCountryId($addressData['country_id']);
                //$address->setCountryId($addressData['country_name']);
